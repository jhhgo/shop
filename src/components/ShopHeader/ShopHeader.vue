<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="toggleInfo">
    ...
    <div class="shop-header-discounts" v-if="info.supports">
      ...
      <div class="discounts-right" @click="toggleSupport">4 个优惠</div>
    </div>
    <transition name="fade">
      <div class="shop-brief-modal" v-show="showInfo">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer">
            <span class="iconfont icon-close" @click="toggleInfo"></span>
          </div>
        </div>
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="showSupport" @click="showSupport=!showSupport">
